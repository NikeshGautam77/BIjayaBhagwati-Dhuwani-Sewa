...
// Fetch from contact_form
$sql = "SELECT id, name, phone, email, message, submitted_at 
...
<head>
  ...
  <style>
    ...
    th { background: #A50021; color: white; }
...
<body>
  ...
  <table>
    <tr>
      <th>ID</th><th>Name</th><th>Phone</th><th>Email</th><th>Message</th><th>Submitted At</th>
    </tr>
    <?php
